...
public class CatGridRecyclerAdapter2 extends RecyclerView.Adapter<CatGridRecyclerAdapter2.CatTileViewHolder> {
    private List<Tile> tiles;

    public CatGridRecyclerAdapter2(List<Tile> tiles) {
        this.tiles = tiles;
    }
